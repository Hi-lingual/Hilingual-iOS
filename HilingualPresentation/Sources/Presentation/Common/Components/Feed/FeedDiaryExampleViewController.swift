...
final class FeedDiaryExampleViewController: UIViewController {
    ...
    private var items: [FeedDiaryItem] = [
        ...
        .init(
            ...
            sharedDateMinutes: 2,
            diaryImg: nil,
            diaryPreviewText: "듀라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라라",
            likeCount: 0,
            isLiked: false
        ),
        .init(
