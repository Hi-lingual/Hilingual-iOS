    ...
    public func search(keyword: String) -> AnyPublisher<BaseAPIResponse<UserListDataDTO>, Error> {
        return Deferred { [keyword] in
            let allUsers = [
                ...
                UserDTO(userId: 3, profileImg: "https://example.com/profile1.jpg", nickname: "하드링", isFollowing: true, isFollowed: true),
                UserDTO(userId: 4, profileImg: "https://example.com/profile3.jpg", nickname: "하쟈링", isFollowing: false, isFollowed: false),
